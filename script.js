    ...
    if(x.id != empty+'') {
        ...
        if((Math.abs(emptyI - selectedI) == 1 && emptyJ == selectedJ) ||
           (Math.abs(emptyJ - selectedJ) == 1 && emptyI == selectedI)) {
            ...
            document.getElementById("moves").innerHTML = "No. of Moves: " + Number_of_moves;
            
            if(isDone()){
                checkWin = true;
                //document.getElementById("moves").innerHTML =
		       window.alert("CONGRATULATIONS! You won the game.\n\nTotal number of moves it took to complete : "  + Number_of_moves + "\nTime spent to complete it : " + time + " second(s) \n\nThank you for playing \nTo play new game, click OK")
